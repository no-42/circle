...
// ../../../ideaProject/circleDemo/node_modules/vue3-emoji/dist/Vue3Emoji.es.js
...
var xe = w("p", { sytle: "margin:0 5px;" }, "最近使用", -1);
  ...
  setup(e, { emit: _ }) {
    ...
    return X(() => {
      ...
      w("div", {
        ...
        n(d) === "recent" ? (j(true), h(A, { key: 0 }, N(n(t), (v, l) => (j(), h("div", {
          class: m(n(b)["emoji-container-item"]),
          key: l,
          onClick: (ie) => U(v),
          title: v.name,
          innerHTML: s(v)
        }, null, 10, ze))), 128)) : (j(true), h(A, { key: 1 }, N(n(E)[n(d)], (v, l) => (j(), h("div", {
          class: m(n(b)["emoji-container-item"]),
          key: l,
          onClick: (ie) => U(v),
          title: v.name,
...
var L = W({
  ...
  setup(e, { expose: _, emit: o }) {
    const g = e, p = k(g.modelValue), c = k(), y = k(), r = k(), d = k(0), a = k(0), u = k(false), E = (t) => {
      let s = t.target;
      if (s) {
